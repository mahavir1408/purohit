...
<form name="addtran" id="addtran" action="addSingleBill.php" method="post"  enctype="multipart/form-data">
...
<div class="mid-wrapper">
	<div class="mid">
        ...
        <div class="cl2ndblock">
                ...
                <tr>
                <td style="font-weight:bold;"><strong>From</strong></td>
                <td colspan="3"> 
                ...
                <tr><td colspan="4">&nbsp;</td></tr>
                <tr>
                <td style="font-weight:bold;"><strong>Invoice no.</strong></td>
                <td><input type="text" name="txFromInvNum" id="idTxFromInvNum" readonly="readonly"/></td>
                <td style="font-weight:bold;"><strong>Invoice Amount</strong></td>
                ...
                <tr>
                <td style="font-weight:bold;"><strong>To</strong></td>
       ...
       <br />  <br />
         ...
         <div class="cl6stblock">
                ...
                <tr id="idTrParti1">
                <td><input type="text" class="validate[required] text-input" name="txParti1" id="idTxParti1" /></td>
                <td> <input type="text" class="validate[required] text-input" onkeyup="calc(this.id)" name="txQty1" id="idTxQty1" /> </td>
                <td><input type="text" class="validate[required] text-input" onkeyup="calc(this.id)" name="txWeight1" id="idTxWeight1"/></td>
                <td><input type="text" class="validate[required] text-input" onkeyup="calc(this.id)" name="txRate1" id="idTxRate1" /></td>
                <td><input type="text" class="validate[required] text-input" name="txAmount1" id="idTxAmount1" /></td>
