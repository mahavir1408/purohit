...
<div class="mid-wrapper">
	<div class="mid">
		    ...
		    <div class="pagehead">
            <a href="#">Monthly Bill Generation Success</a>
            </div>
            <br />
            
             <table style="width:400px; border:solid 1px #000; margin:0 auto; border-collapse:collapse; text-align:left; text-indent:5px;">
            <tr><td colspan="2" style="border:solid 1px #000; background-color:#eeeeee; font-weight:bold;"> Monthly Bill Generated Successfully </td></tr>
