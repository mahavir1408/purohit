...
<script language="javascript" src="js/Get_ServiceTaxList.js" type="text/javascript" ></script>
...
<div class="mid-wrapper">
	<div class="mid">
            ...
            <tr>
            <td>From Date&nbsp;</td>
            <td>&nbsp;<input type="text" id="idTxFromDate" readonly="readonly" class="validate[required] text-input" /></td>
            <td>&nbsp;&nbsp;&nbsp;To Date</td>
            <td>&nbsp;<input type="text" id="idTxToDate" readonly="readonly" class="validate[required] text-input" /></td>
            </tr>
            </table>
            
            <br />
            
            <table style="margin:0 auto;" id="idTbStReport">
            <tr>
            <th>Customer Name</th>
            <th>Bill no.</th>
            <th>Bill Date</th>
