...
<div class="mid-wrapper">
	<div class="mid">
            ...
            <tr><td colspan="2" style="border:solid 1px #000; background-color:#eeeeee; font-weight:bold;"> Error </td></tr>
            <tr><td   style="border:solid 1px #000;">  <?php  	echo $_SESSION['TranError']; unset($_SESSION['TranError']); 	?>  </td></tr>
            </table>
