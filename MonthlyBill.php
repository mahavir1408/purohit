...
<script language="javascript" src="js/MonthlyBill.js" type="text/javascript" ></script>
...
<form name="addMonthlyBill" id="addMonthlyBill" action="addMonthlyBill.php" method="post"  enctype="multipart/form-data">
...
<div class="mid-wrapper">
	<div class="mid">
            ...
            <div class="pagehead">
            <a href="#">Generate Monthly Bill</a>
            </div>
            <br />
            ...
            <td>Bill Date</td>
            <td>
            <input type="text" readonly="readonly" class="validate[required]" name="txBillDt" id="idTxBillDt" />
            </td>
            </tr>
            ...
            <td colspan="3"> 
            <input type="text" name="txPayBy"  class="validate[required,funcCall[PaybyNameTrim],ajax[ajaxUserCallnameforSbill]] text-input" style="width:550px;"  onkeypress="resetcid(event,'idTxPaybyCid','idTxPayby')"  id="idTxPayby" /> <img src="images/loading.gif" class="loading" style="display:none;" /> <br />
            ...
            <td><input type="text" readonly="readonly" class="validate[required]" name="txFromDt" id="idTxFromDt" /></td>
            <td>Docket To Date</td>
            <td><input type="text" readonly="readonly" class="validate[required]" name="txToDt" id="idTxToDt"  /> </td>
            </tr>
            <tr><td colspan="4">&nbsp;</td></tr>
            <tr><td colspan="4">
            ...
            <tr><td colspan="4">&nbsp;</td></tr>
            	...
            	<tr>
                <td>Total</td>
                <td colspan="3"><input type="text" name="txTot" id="txIdTot" class="validate[required]" readonly="readonly" /></td>
                </tr>
                <tr>
                <td>Servcie Tax &nbsp;<input type="text" name="txServcieTaxRate" value="12" style="font-size:10px; height:15px; width:50px;" id="idTxServcieTaxRate" onkeyup="calcbill()" class="validate[required]" /> % &nbsp;</td>
                <td colspan="3"><input type="text" name="txServcieTax" id="txIdServcieTax" class="validate[required]"  readonly="readonly"/></td>
                </tr>
                <tr>
                <td>Edu Chess &nbsp;<input type="text" name="txEduChessRate" value="2" style="font-size:10px; height:15px; width:50px;" id="idTxEduChessRate" onkeyup="calcbill()" class="validate[required]" /> %  &nbsp;</td>
                <td colspan="3"><input type="text" name="txEduChess" id="txIdEduChess" class="validate[required]" readonly="readonly" /></td>
                </tr>
                <tr>
                <td>Higher Edu Chess &nbsp;<input type="text" name="txHighEduChessRate" value="1" style="font-size:10px; height:15px; width:50px;" id="idTxHighEduChessRate" onkeyup="calcbill()"  class="validate[required]" /> %  &nbsp;</td>
                <td colspan="3"><input type="text" name="txHighEduChess" id="txIdHighEduChess" class="validate[required]" /></td>
                </tr>
                <tr>
                <td>Labour Carges</td>
                ...
                <td colspan="3"><input type="text" name="txPreGT"  id="txIdPreGT" class="validate[required]" /></td>
                </tr>
                <tr>
                <td>Grand Total</td>
                <td colspan="3"><input type="text" name="txGT"  id="txIdGT"class="validate[required]" /></td>
                </tr>
