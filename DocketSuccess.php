...
<div class="mid-wrapper">
	<div class="mid">
		    ...
		    <div class="pagehead">
            <a href="#">Docket Generation Status</a>
            </div>
            <br />
			
            <table style="width:400px; border:solid 1px #000; margin:0 auto; border-collapse:collapse; text-align:left; text-indent:5px;">
            <tr><td colspan="2" style="border:solid 1px #000; background-color:#eeeeee; font-weight:bold;"> Docket Generated Successfully </td></tr>
            <tr><td  style="border:solid 1px #000;">Docket No. -</td><td   style="border:solid 1px #000;">  <?php  	echo $_SESSION['Dnum']; unset($_SESSION['Dnum']); 	?>  </td></tr>
            <tr><td  style="border:solid 1px #000;">C No. -</td><td   style="border:solid 1px #000;">  <?php		echo $_SESSION['Cnum']; unset($_SESSION['Cnum']);	?>  </td></tr>
            </table>
