...
<script language="javascript" src="js/EditMonthlyTranscation.js" type="text/javascript" ></script>
...
function AddRow()
{
    ...
    $('#tbParti').append( 	'<tr id="idTrParti'+ count +'">' +
							...
							'<td><a href="javascript:void(0);" id="idADelItem" onclick="DelRow(\'idTrParti'+count+'\')" >Delete Item</a></td> <input type="hidden" name="hfPid'+ count +'" id="idHfPid'+ count +'" value="0" /> ' +
							'</tr>' );
...
<form name="editTran" id="editTran" action="updateMonthlyTranscation.php" method="post"  enctype="multipart/form-data">
...
<div class="mid-wrapper">
	<div class="mid">
        ...
        <div class="pagehead">
        <a href="#">Edit Monthly Transcation</a>
        </div>
	    <br />
        ...
        <div class="cl2ndblock">
                ...
                <input type="hidden" id="idHfBilledStatus" name="hfBilledStatus" value="0" />
                <input type="hidden" id="idHfBillId" name="hfBillId" value="0" />
                <input type="hidden" id="idHfDocketSum" name="hfDocketSum" value="0" />
                
                <input type="hidden" id="idHfServcieTaxRate" name="hfServcieTaxRate" value="0" />
                <input type="hidden" id="idHfEduChessRate" name="hfEduChessRate" value="0" />
                <input type="hidden" id="idHfHighEduChessRate" name="hfHighEduChessRate" value="0" />
                
                <input type="hidden" id="idHfLabout" name="hfLabout" value="0" />
                <input type="hidden" id="idHfWaiting" name="hfWaiting" value="0" />
                <input type="hidden" id="idHfOther" name="hfOther" value="0" />
                
                <input type="hidden" id="idHfManualDocNum" value="0" />
       ...
       <br />  <br />
         ...
         <div class="cl6stblock">
                ...
                <input type="hidden" name="hiRowCount" id="idHiRowCount" value="0"  />
