...
<div class="mid-wrapper">
	...
	<?php
		...
		$SqlInsertAccountsTran = "INSERT INTO ACCOUNTS VALUES ('', '{$_POST['seTranTyp']}', STR_TO_DATE('{$_POST['txDate']}', '%d-%m-%Y'), '{$_POST['txDesc']}', '{$_POST['txAmt']}', '{$_POST['sePayMode']}', '{$_POST['txToFrom']}', '{$_POST['txcustid']}', '{$_SESSION['cid']}'   )";
