<?php
	...
	$sqlGetDocketDid = "select did, date from docket where live=1 and deleted=1 and billed=1 and trantype=2 and ( bid=0 OR bid='$bid' )  and  pid='{$_SESSION['cid']}' and Fromname='$from' and toname='$to' ORDER BY date ASC ";
