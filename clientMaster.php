...
<script type="text/javascript" language="javascript">
		...
		jQuery(document).ready(function(){
			$("#comaster").validationEngine({ scroll: true, showArrow: true  });
		});
...
<form name="comaster" id="comaster" action="addClient.php"  method="post" enctype="multipart/form-data">
...
<div class="mid-wrapper">
	<div class="mid">
               ...
               <!-- <tr>
                ...
                <td> <input type="text" id="idTxLocation" name="txLocation" onkeydown="validatesname('idTxLocation')" class="validate[required,groupRequired[payByShortName],custom[onlyLetterSp],ajax[ajaxUserCallsnames]] text-input"  /> </td>
                </tr>
                <tr>
                <td>Country</td>
                <td>
                ...
                <tr>
                <td>Monthly Rate</td>
                <td><input type="text" name="naMonthlyRate" class="validate[custom[onlyNumberSp]] text-input" /></td
                ></tr>
                
                <tr>
                <td>Till KG</td>
                <td><input type="text" name="naTillKg" class="validate[custom[onlyNumberSp]] text-input" /></td>
                <td>Till Kg Rate</td>
                <td><input type="text" name="naTillKgRate" class="validate[custom[onlyNumberSp]] text-input" /></td>
                </tr>
                
               
                <tr>
                <td>Above Till Kg Rate</td>
                <td><input type="text" name="naAboveTillKgRae" class="validate[custom[onlyNumberSp]] text-input"  /></td>
                </tr>
                
                <tr> 
                <td colspan="4" style="text-align:right;">  <button type="submit"  id="btnsubmit" value="Submit">Add Client</button> </td>
                </tr>
                </table>
